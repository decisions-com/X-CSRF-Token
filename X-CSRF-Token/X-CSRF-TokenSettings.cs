...
/// </summary>
namespace X-CSRF-Token
{
    [ORMEntity]
    [DataContract]
    public class X-CSRF-TokenSettings : AbstractModuleSettings
    {
        public X-CSRF-TokenSettings()
        {
            EntityName = "X-CSRF-Token Custom App Settings";
        }
        ...
        public override BaseActionType[] GetActions(AbstractUserContext userContext, EntityActionType[] types)
        {
            ...
            results.Add(new EditObjectAction(typeof(X-CSRF-TokenSettings), "Edit", null, "Edit", ()=> { return this; }, SaveChanges));
