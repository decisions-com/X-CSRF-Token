...
namespace XCSRFToken
{
    [ORMEntity]
    [DataContract]
    public class XCSRFTokenSettings : AbstractModuleSettings
    {
        public XCSRFTokenSettings()
        {
            EntityName = "XCSRFToken Custom App Settings";
        }
        ...
        public override BaseActionType[] GetActions(AbstractUserContext userContext, EntityActionType[] types)
        {
            ...
            results.Add(new EditObjectAction(typeof(XCSRFTokenSettings), "Edit", null, "Edit", ()=> { return this; }, SaveChanges));
